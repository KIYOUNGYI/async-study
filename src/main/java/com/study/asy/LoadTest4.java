...
public class LoadTest4 {
    ...
    public static void main(String[] args) throws InterruptedException, BrokenBarrierException {
        ...
        //리액트 기반 event 데모 프로젝트
//        String url = "http://localhost:8999/api/webflux/event/11304?isDebug=true";
//        event 개발기
//        String url = "https://event-api-j.glowpick.net/api/event/11304?isDebug=true";

        //event 로컬, 포트 바꿈
        String url = "http://localhost:8998/api/event/11304";

        CyclicBarrier barrier = new CyclicBarrier(501);

        UriComponentsBuilder uriBuilder = UriComponentsBuilder.fromHttpUrl(url)
                .queryParam("data", "CgIIFBICCBQ")
